...
class Player {
  ...
  strike (player, enemy, attackDmg) {
    ...
    console.log (`${player.name} attacks ${enemy.name} for ${damageAmount} HP`);
  }
...
let p1 = new Player ('Umair', 100, 10);
let p2 = new Player ('Zubair', 100, 10);
